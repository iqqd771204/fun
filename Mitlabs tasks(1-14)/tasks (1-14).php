...
/* 4. Вывести на экран n-ное число Фибоначчи.*/
...
$sum=0;
	...
	echo "$number число фибоначи - $sum";
}
...
if ($numOfRem==0) echo "Нечетных цифр не обнаружено";
}
...
/* 9. Задайте случайным образом массив из N элементов. Выведите его на экран "ёлочкой".*/
